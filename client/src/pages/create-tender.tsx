...
const tenderSchema = z.object({
  ...
  submissionDeadline: z.string().min(1, 'Submission deadline is required').transform((val) => new Date(val)),
  openingDate: z.string().min(1, 'Opening date is required').transform((val) => new Date(val)),
